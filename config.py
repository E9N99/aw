...
BOT_TOKEN = getenv("BOT_TOKEN", "7355171571:AAEP20EaHwTtICy4tvix6XtspZz5pvWiK4o")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID",-1002059513294))

OWNER_ID = int(getenv("OWNER_ID", 7291869416))

OWNER = int(getenv("OWNER", 7291869416))
